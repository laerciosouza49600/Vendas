...
-- Copiando dados para a tabela sistema.usuarios: ~3 rows (aproximadamente)
/*!40000 ALTER TABLE `usuarios` DISABLE KEYS */;
INSERT INTO `usuarios` (`id_usuario`, `nome`, `cpf`) VALUES
	(1, 'laercio', '060.760-11'),
	(2, 'Ester', '09876543239'),
	(5, 'WillianVeras', '2340967527');
/*!40000 ALTER TABLE `usuarios` ENABLE KEYS */;

-- Copiando dados para a tabela sistema.venda: ~1 rows (aproximadamente)
/*!40000 ALTER TABLE `venda` DISABLE KEYS */;
INSERT INTO `venda` (`id_venda`, `quantidade`, `preco`) VALUES
	(1, 13, 53);
